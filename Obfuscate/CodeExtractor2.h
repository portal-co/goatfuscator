...
#ifndef LLVM_TRANSFORMS_UTILS_CODEEXTRACTOR2_H
#define LLVM_TRANSFORMS_UTILS_CODEEXTRACTOR2_H
...
class CodeExtractor2AnalysisCache {
...
public:
  CodeExtractor2AnalysisCache(Function &F);
  ...
  public:
    ...
    /// space.
    CodeExtractor2(ArrayRef<BasicBlock *> BBs, DominatorTree *DT = nullptr,
    ...
    CodeExtractor2(DominatorTree &DT, Loop &L, bool AggregateArgs = false,
    ...
    /// returns false.
    Function *extractCodeRegion(const CodeExtractor2AnalysisCache &CEAC);
    ...
    bool
    isLegalToShrinkwrapLifetimeMarkers(const CodeExtractor2AnalysisCache &CEAC,
    ...
    /// 'Allocas'.
    void findAllocas(const CodeExtractor2AnalysisCache &CEAC,
  ...
  private:
    ...
    LifetimeMarkerInfo
    getLifetimeMarkers(const CodeExtractor2AnalysisCache &CEAC,
